...
class Active_Learning():
    ...
    def eval_classifier(self, reference_labels):
        ...
        with suppress_stdout():
            ...
            classifier_purity = purity_score(reference_labels[0:self.num_docs], local_training_preds[0:self.num_docs])
            classifier_RI = rand_score(reference_labels[0:self.num_docs], local_training_preds[0:self.num_docs])
            classifier_NMI = normalized_mutual_info_score(reference_labels[0:self.num_docs], local_training_preds[0:self.num_docs])

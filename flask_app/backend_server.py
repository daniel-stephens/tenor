...
class User():
    ...
    '''
    def __init__(self, user_id, raw_texts, model_type, num_topics=35, data_path='./Data/bills/congressional_bill_train_processed.pkl', labels=None):
        '''
        ...
        self.slda_save_path = './Topic_Models/trained_models/SLDA_user{}.pkl'.format(self.user_id)
        '''
        ...
        if model_type == 'LDA' or model_type == 'SLDA' or model_type == 'CTM':
            ...
            model_path = './Topic_Models/trained_models/{}_{}.pkl'.format(model_type, num_topics)
            if model_type == 'CTM':
